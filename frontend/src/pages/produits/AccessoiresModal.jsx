...
// Panneau « Accessoires liés » — utilisé dans l'onglet Accessoires du
// formulaire produit à onglets (back-office manager/admin).
...
export default function AccessoiresPanel({ produit }) {
    ...
    <div>
      ...
      <div className='bg-gray-50 rounded-xl p-4 mb-4'>
        ...
        <div className='flex gap-2'>
          ...
          <button type='button' onClick={ajouter} disabled={ajoutEnCours}
      ...
      {chargement ? (
        ...
        <div className='text-center py-8 text-gray-400'>
          ...
          <p className='text-xs mt-1'>Ajoutez-en pour les suggérer à la caisse.</p>
        </div>
      ) : (
        <div className='space-y-2'>
          {accessoires.map(acc => (
            <div key={acc.id}
              ...
              <button type='button' onClick={() => retirer(acc.id)}
